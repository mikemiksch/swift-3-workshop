...
default:
    print("(\(somePoint.x), \(somePoint.y)) is outside the box")
}
...
let myTuple = (x: 2, y: 3, height: 2, width: 3)

switch myTuple {
case myTuple.x != myTuple.height:
    print("Height and x coordinate do not match!")
}